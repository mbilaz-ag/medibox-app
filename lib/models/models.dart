...
class Med {
  ...
  Med({
    ...
    this.doseMgPerKg = '',
    this.doseFixedMg = '',
    this.doseMaxSingleMg = '',
    this.doseMaxDailyMg = '',
    this.doseIntervalHours = '',
    this.concentrationMgPerMl = '',
    this.unitStrengthMg = '',
    this.doseRuleSource = '',
    this.doseRuleVerified = false,
    this.atcCode = '',
  ...
  Map<String, dynamic> toJson() => {
    ...
    'doseFixedMg': doseFixedMg,
    'doseMaxSingleMg': doseMaxSingleMg,
    'doseMaxDailyMg': doseMaxDailyMg,
    'doseIntervalHours': doseIntervalHours,
    'concentrationMgPerMl': concentrationMgPerMl,
    'unitStrengthMg': unitStrengthMg,
    'doseRuleSource': doseRuleSource,
  ...
  factory Med.fromJson(Map<String, dynamic> j) => Med(
    ...
    doseMgPerKg: '${j['doseMgPerKg'] ?? ''}',
    doseFixedMg: '${j['doseFixedMg'] ?? ''}',
    doseMaxSingleMg: '${j['doseMaxSingleMg'] ?? ''}',
    doseMaxDailyMg: '${j['doseMaxDailyMg'] ?? ''}',
    doseIntervalHours: '${j['doseIntervalHours'] ?? ''}',
    concentrationMgPerMl: '${j['concentrationMgPerMl'] ?? ''}',
    unitStrengthMg: '${j['unitStrengthMg'] ?? ''}',
    doseRuleSource: '${j['doseRuleSource'] ?? ''}',
    doseRuleVerified: j['doseRuleVerified'] == true,
